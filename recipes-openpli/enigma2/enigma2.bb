...
GST_BASE_RDEPS = " \
	...
	gstreamer1.0-plugins-base-decodebin \
	gstreamer1.0-plugins-base-decodebin2 \
	gstreamer1.0-plugins-base-ogg \
	gstreamer1.0-plugins-base-playbin \
...
GST_BAD_RDEPS = " \
	...
	gstreamer1.0-plugins-bad-mpegdemux \
...
GST_UGLY_RDEPS = " \
	...
	gstreamer1.0-plugins-ugly-mpegaudioparse \
	gstreamer1.0-plugins-ugly-mpegstream \
	"
...
SRC_URI = "git://github.com/noone2k/openpli-enigma2.git;protocol=git;branch=${ENIGMA2_BRANCH}"
